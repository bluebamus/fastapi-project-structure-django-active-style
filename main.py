...
#
# 여기서 발견·초기화를 호출하는 위치가 중요하다. install_hooks() 가 각 앱의
# apps.ready() 를 실행하는데(예: home 의 access-log sink 등록), 그 등록은 미들웨어
# 설정보다 먼저 끝나 있어야 한다. 그래서 FastAPI 인스턴스를 만들기 전에 마친다.
# =============================================================================
