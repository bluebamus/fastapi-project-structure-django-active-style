...
1. [프로젝트 구조 및 기능 개선 계획](01-project-hardening-plan-2026-08-11.md)
   ...
   - ⚠ 기준선 교체(3번 문서) 이후 **하드닝 4건(DB 오류 비노출·접근 로그 보호·lifespan
     정리·DB routing)이 현재 코드에 없다.** 미결 사항이므로 이 문서의 상태표를 먼저 볼 것.
...
| 순서 | 문서 | 성격 | 주요 내용 |
|---|---|---|---|
| 1 | `01-project-hardening-plan-2026-08-11.md` | 검토·개선 기록 | 초기 문제, 권장 우선순위, **기준선 교체 후 재확인한 실제 적용 여부** |
