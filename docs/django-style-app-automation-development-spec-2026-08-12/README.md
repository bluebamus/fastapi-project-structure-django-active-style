...
1. [Django 식 앱 자동 등록 설계와 개발 내역](02-django-style-app-discovery-concept-2026-08-12.md)
   - 프로젝트 목적, Django 대응 범위, 자동 발견·결선 원리와 설계 근거를 설명한다.
2. [Django 스타일 앱 자동화 개발 명세](03-django-style-app-automation-development-spec-2026-08-12.md)
...
| 순서 | 문서 | 성격 | 주요 내용 |
|---|---|---|---|
| 1 | `02-django-style-app-discovery-concept-2026-08-12.md` | 개념·설계 근거 | Django 대응, registry 원리, 앱 규약, 운영 경계 |
| 2 | `03-django-style-app-automation-development-spec-2026-08-12.md` | 실행 명세 | `FR/CR/NFR/BC/SEC/AC` 요구사항, 설계, 개발·검증·Git 계획 |
